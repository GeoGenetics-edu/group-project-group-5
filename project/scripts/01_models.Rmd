...
dat <- readRDS("C:/Users/bruge/Documents/group-project-group-5/project/data/prepared_data_final.rds")
...
cat("GLMNET CV AUC:", results_glmnet$performance$cv_metric_AUC, "\n")
cat("GLMNET Accuracy:", results_glmnet$performance$Accuracy, "\n")
cat("\nRF CV AUC:", results_rf$performance$cv_metric_AUC, "\n")
cat("RF Accuracy:", results_rf$performance$Accuracy, "\n")
```
...
print(
  combined_perf %>%
  select(method, cv_metric_auc, accuracy)
)
```
...
perf_long <- combined_perf %>%
  select(method, cv_metric_auc, accuracy) %>% #prAUC,
