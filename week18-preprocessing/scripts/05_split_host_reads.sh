...
#SBATCH --output=/maps/projects/course_1/scratch/group5/logs/%x_%j.out
#SBATCH --error=/maps/projects/course_1/scratch/group5/logs/%x_%j.err
#SBATCH --ntasks=1
